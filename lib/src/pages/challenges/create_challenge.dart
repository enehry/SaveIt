    ...
    if (_formKey.currentState != null) {
      if (_formKey.currentState!.validate()) {
        ...
        Challenge challenge = Challenge(
          id: const Uuid().v1(),
          title: title,
          iconCode: Icons.savings_outlined.codePoint,
          total: double.parse(totalAmount.replaceAll(',', '')),
          dateCreated: DateTime.now(),
          // parse the dates
          startDate: DateFormat.yMd().parse(startDate),
          endDate: DateFormat.yMd().parse(endDate),
          frequency: frequency,
        );
